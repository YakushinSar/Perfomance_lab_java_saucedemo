...
public class ProductsPage extends BasePage {
    ...
    private final By PAGE_LOADED_INDICATOR = By.className("inventory_list");
    ...
    @Override
    @Step("Загрузка страницы Products")
    public ProductsPage isPageOpened() {
        log.info("Waiting for Products page to load");
    ...
    public ProductsPage openPage() {
        log.info("Opening Products page: {}", BASE_URL + "/inventory.html");
    ...
    @Step("Нажатие на кнопку Add to cart по индексу {index}")
    public ProductsPage clickAddToCartButton(int index) {
        log.info("Clicking 'Add to cart' button for product at index {}", index);
    ...
    public int getCartItemCount() {
        try {
            ...
            log.warn("Cart badge not found, returning 0");
            return 0;
        }
    }
