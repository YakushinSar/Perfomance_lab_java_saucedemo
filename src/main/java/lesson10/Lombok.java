...
# Lombok - использование. Lombok работает на этапе компиляции — готовый код можно посмотреть в target/classes В рантайме аннотаций уже нет — они подставляют готовый
 код. Над классом Pages ставится аннотация которая нужна, данные lombok генерирует сам.
...
7.@Data – глобальная аннатоация, генерирует все сразу - генерация getter, setter, toString, equals и hashCode функций
